...
export default function sepha_special({ navigation, route }) {
    ...
    return (
        <>
            ...
            <LinearGradient
                colors={DarkMode ? ["#000", '#fff'] : ['#8af12d', '#19a777']}
                style={{
                    width: width,
                    height: height,
                    alignItems: 'center',
                    ...
                    {listArray.map((item, index) =>
                        <>
                            ...
                            >
                                ...
                                >
                                    <Image source={require('../img/play-button.png')} style={{
                                        width: width * 0.25,
                                        height: height * 0.14,
                                        borderRadius: 504,
                                        resizeMode: "contain",
            ...
            >
                <Animatable.View style={{
                    width: width * 0.9,
                    height: height * 0.3,
                    backgroundColor: DarkMode ? '#000' : '#19a777',
                    borderRadius: 20,
                    alignItems: 'center',
                    //   justifyContent: 'center',
                ...
                >
                    ...
                    <TextInput style={{
                        width: width * 0.85,
                        backgroundColor: DarkMode ? '#fff' : '#8af15d',
                        borderRadius: 10,
                        padding: 9,
                        color: "#000",
                    }}
            ...
            >
                <Animatable.View style={{
                    ...
                    <TouchableOpacity style={{
                        ...
                        height: height * 0.05,
                        borderRadius: 12,
                        backgroundColor: DarkMode ? '#bcc01f' : '#fff',
                        alignItems: 'center',
                        justifyContent: 'center'
                    }}
                            ...
                            <>
                                <View style={{
                                    ...
                                    <TouchableOpacity
                                        onPress={() => del(index)}
                                    >
                                        <Icon3 name="delete" size={30} color={DarkMode ? '#000' : "#f00"} style={{
            ...
            >
                <Icon1 name='add-comment' size={30} color='#fff' />
